...
def get_args():
    ...
    # some args
    parser.add_argument('--exp_name', type = str, default='ModelNet40', help = 'experiment name')
    parser.add_argument('--loss', type=str, default='cd1', help='loss name')
    parser.add_argument('--start_ckpts', type = str, default=None, help = 'reload used ckpt path')
    # parser.add_argument('--ckpts', type = str, default="pretrain.pth", help = 'test used ckpt path')
    parser.add_argument('--ckpts', type = str, help = 'test used ckpt path')
