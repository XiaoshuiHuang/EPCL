...
class ScannetDataset(DatasetTemplate):
    ...
    def __len__(self):
        ...
        return len(self.scannet_infos) # 12010
    ...
    def __getitem__(self, index):
        ...
        info = copy.deepcopy(self.scannet_infos[index]) # 一个点云文件，dict_keys(['point_cloud', 'pts_path', 'pts_instance_mask_path', 'pts_semantic_mask_path', 'annos'])

        sample_idx = info['point_cloud']['lidar_idx']
        get_item_list = self.dataset_cfg.get('GET_ITEM_LIST', ['points']) # ['points', 'instance_mask', 'semantic_mask']
