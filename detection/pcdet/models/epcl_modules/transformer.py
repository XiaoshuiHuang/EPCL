...
from .util_modules import SparseGroup, EmbeddingEncoder
...
class EPCLPreEncoder(nn.Module):
    ...
    def forward(self, pts, feats=None):
        ...
        _, center, batch_idx, batch_xyz, neighborhood_feats = self.group_divider(pts, feats)
        group_input_tokens = self.encoder(neighborhood_feats)
     
        return center, group_input_tokens.permute(0, 2, 1), batch_idx, batch_xyz   
