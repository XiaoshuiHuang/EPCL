...
class CAGroup3DHead(nn.Module):
    ...
    def forward(self, input_dict, return_middle_feature=True):
        ...
        decode_out = [None, None, None, out] # len(lsit)=4
        semantic_scores = self.semantic_conv(out) # [B*N,n_class]
        ...
        for cls_id in range(self.n_classes):
            ...
            voxel_coord[:, 1:] = (fuse_coordinates[:, 1:] / voxel_size).floor() # 体素化
            ...
            expand = self.expand # 将voxel_size*3
